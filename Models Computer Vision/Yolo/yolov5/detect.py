...
def run(
    weights=ROOT / "runs/train/exp22/weights/best.pt",  # model path or triton URL
    ...
    Args:
        ...
        source (str | Path): Input source, which can be a file, directory, URL, glob pattern, screen capture, or webcam index.
            Default is 'dataset/test/images'.
...
def parse_opt():
    ...
    Args:
        ...
        --source (str, optional): File/dir/URL/glob/screen/0(webcam). Defaults to ROOT / 'dataset/test/images'.
    ...
    parser.add_argument("--weights", nargs="+", type=str, default=ROOT / "runs/train/exp22/weights/best.pt", help="model path or triton URL")
    parser.add_argument("--source", type=str, default=ROOT / "dataset/test/images", help="file/dir/URL/glob/screen/0(webcam)")
